...
#           "2_analysis/raxml/hyp155_a_0.33_mac4_5kb.raxml.mlTreeBest")
...
tree_s_rooted <- root(tree_s , outgroup="PL17_160floflo")#, outgroup = c("28393torpan", "s_tort_3torpan", "20478tabhon" ))
