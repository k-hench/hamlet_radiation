#!/usr/bin/env Rscript
# run from terminal:
# Rscript --vanilla R/fig/plot_SFz4.R 2_analysis/raxml/lg04.1_hySN.raxml.support \
#    2_analysis/raxml/lg12.3_hySN.raxml.support \
#    2_analysis/raxml/lg12.4_hySN.raxml.support
# ===============================================================
# This script produces Suppl. Figure z3 of the study "Ancestral variation,
