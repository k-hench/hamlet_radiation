#!/usr/bin/env Rscript
# run from terminal:
# Rscript --vanilla R/fig/plot_SFx5.R figures/data/pi/ figures/data/fasteprr/fasteprr.all.rho.txt.gz
# ===============================================================
# This script
# ---------------------------------------------------------------
# ===============================================================
# args <- c('figures/data/pi/', 'figures/data/fasteprr/fasteprr.all.rho.txt.gz')
