...
# Analysis I (<it>F<sub>ST</sub></it>_ & GxP)
...
For historic reasons, we perform a PCA on the phenotypes and reoport the extended phenotype data including the scoring on PC1 & PC2.
...
Then, we combine the reformatted genotypes with the phenotyes and the traits of interrest.
...
Having collectet all the input, we can now run the GxP.
