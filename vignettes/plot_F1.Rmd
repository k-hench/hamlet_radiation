...
<center>
```{r, echo = FALSE, fig.width = 9, fig.height = 2.9, dev.args = list(type = "cairo")}
p1
```
</center>
...
<center>
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 4.5, fig.height = 4.1, dev.args = list(type = "cairo")}
p2
```
</center>
...
<center>
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 11, fig.height = 6.5, dev.args = list(type = "cairo")}
p_done
```
</center>
