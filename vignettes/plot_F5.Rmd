...
<center>
```{r, echo = FALSE, fig.width = 14, fig.height = 9.33, dev.args = list(type = "cairo")}
p_single
```
</center>
...
<center>
```{r, echo = FALSE, fig.width = 14, fig.height = 2.1, dev.args = list(type = "cairo")}
p_leg
```
</center>
...
<center>
```{r, echo = FALSE, fig.width = 14, fig.height = 10.4, dev.args = list(type = "cairo")}
p_done
```
</center>
