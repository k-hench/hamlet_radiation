...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 10, fig.height = 12, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p1) + 
  draw_plot(hypoimg:::hypo_logo(.4), .1, .1, .8, .8) +
  draw_label("docs version", color = rgb(0,0,0,.2), size = 75, angle = 45)
```
...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 5, fig.height = 4, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p2) + 
  draw_plot(hypoimg:::hypo_logo(.4), .1, .1, .8, .8) +
