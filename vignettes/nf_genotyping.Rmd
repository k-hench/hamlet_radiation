...
The `genotyping.nf` workflow contains an appendix that makes use of the genotyping likelyhoods created in step git 1.10 to create an indel mask that is later used in the inference of the hamlet demographic history ([git 8.x](analysis-vi-demographic-history.html)).
...
The linkage group channel is combined with the filterd indels.
...
All indel masks are exported to the ressources folder within the root directory.
