...
```{r, echo = FALSE, fig.width = f_width, fig.height = .5, dev.args = list(type = "cairo"), fig.align = "center"}
p_leg
```
...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = f_width, fig.height = 3, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p_done) + 
