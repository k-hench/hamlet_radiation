...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = f_width_half, fig.height = 1.8, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p_net) + 
  draw_plot(hypoimg:::hypo_logo(.4), .1, .1, .8, .8) +
  draw_label("docs version", color = rgb(0,0,0,.2), size = 35, angle = 25)
```
