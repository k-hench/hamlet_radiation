...
A supersede version of the whole genome phylogeny and the topology weighting are prepared within the [**nextflow**](https://www.nextflow.io/) script `analysis_fasttree_twisst.nf` (located under `$BASE_DIR/nf/05_analysis_fasttree_twisst/`), which runs on the _SNPs only_ data set.
