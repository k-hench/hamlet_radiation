...
The demographic history rate is inferred within the [**nextflow**](https://www.nextflow.io/) script `analysis_msmc.nf` (located under `$BASE_DIR/nf/analysis_msmc/`), which runs on the _SNPs only_ data set.
