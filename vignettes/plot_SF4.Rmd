...
To be able to indicate the genome wide average in the background of the plot, we summarize the $d_{XY}$ data for each pair wise comparison and store the summary in a new table.
...
For the hamlet illustrations, we also create a table in which we assign each comparison the matching illustration.
...
The global average $d_{XY}$ indicated in the plot background uses a secondary x-axis. 
