...
```{r, message = FALSE, warning = FALSE, fig.width = f_width_half, fig.height = 3.2585, dev.args = list(type = "cairo"), fig.align = "center"}
# config -----------------------
...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 6 * 1.5, fig.height = 4 * 1.5, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p_tree) + 
  draw_plot(hypoimg:::hypo_logo(.4), .1, .1, .8, .8) +
  draw_label("docs version", color = rgb(0,0,0,.2), size = 65, angle = 45)
```
...
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 7.5 * 1.5, fig.height = 4 * 1.5, dev.args = list(type = "cairo"), fig.align = "center"}
ggdraw(p_done) + 
  draw_plot(hypoimg:::hypo_logo(.4), .1, .1, .8, .8) +
  draw_label("docs version", color = rgb(0,0,0,.2), size = 65, angle = 45)
```
