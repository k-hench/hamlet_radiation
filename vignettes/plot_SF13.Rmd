...
<center>
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 14.4, fig.height = 2.5, dev.args = list(type = "cairo")}
p_ad[[3]]
```
</center>
...
<center>
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 14.4, fig.height = 1.6, dev.args = list(type = "cairo")}
p_spec
```
</center>
...
<center>
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 14.4, fig.height = 1, dev.args = list(type = "cairo")}
p_loc
```
</center>
...
<center>
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 14.4, fig.height = 2, dev.args = list(type = "cairo")}
p_l
```
</center>
...
<center>
```{r, message = FALSE, warning = FALSE, echo = FALSE, fig.width = 14.4, fig.height = 9, dev.args = list(type = "cairo")}
p_done2
```
</center>

Finally, we can export Supplementary Figure 13.
