...
- git 15.x: [Analysis ($\pi$ with/without outlier regions)](git-14-analysis-xii-outlier-region-phylogenies.html)
- git 16.x: [Analysis (IBD)](git-14-analysis-xii-outlier-region-phylogenies.html)
- git 17.x: [Analysis (dstats)](git-14-analysis-xii-outlier-region-phylogenies.html)
- git 18.x: [Genotyping all base pairs (mtDNA and unplaced Contigs)](git-14-analysis-xii-outlier-region-phylogenies.html)
- git 19.x: [Analysis (Serraninae phyologeny)](git-14-analysis-xii-outlier-region-phylogenies.html)
